import string, time
import numpy as np
from kkelo import Elo, TrueSkill


for Rating in [Elo, TrueSkill]:
    N        = 10000
    ...
    timest  = time.time()
    elo2    = Rating(is_check=False, monitors=ndfpl[:5])
    ...
    elo2.monitors_to_pandas()
    elo2.monitors_to_plot()